    ...
    public static class SmartDispatcher
    {
        ...
        private static void RequireInstance()
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new InvalidOperationException("The first time SmartDispatcher is used must be from a user interface thread. Consider having the application call Initialize, with or without an instance.", ex);
            }
